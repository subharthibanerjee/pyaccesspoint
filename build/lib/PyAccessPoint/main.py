...
def create_config_json(channel='6', hwmode='n', wlan='wlan0', inet=None, ip='192.168.45.1', netmask='255.255.255.0', ssid='MyAccessPoint',
                       password='1234567890'):
    return {'channel':channel, 'hwmode':hwmode, 'wlan': wlan, 'inet': inet, 'ip': ip, 'netmask': netmask, 'ssid': ssid, 'password': password}
...
def main():
    ...
    parser.add_argument('-ch', "--channel", required=False, default='6', help='channel between 1-11')
    
    parser.add_argument('-hw', "--hwmode", required=False, default='n', help='select between b,g,n')
    ...
    if args.config:
        ...
        config_json = create_config_json(args.channel, args.hwmode, args.wlan, args.inet, args.ip, args.netmask, args.ssid, args.password)
